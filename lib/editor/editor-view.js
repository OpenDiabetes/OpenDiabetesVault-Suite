...
export default class EditorView {
  ...
  serialize() {
    ...
    return {
      deserializer: 'open-diabetes-vault-suite/EditorView',
      workspace: workspace,
  ...
  getTitle() {
    ...
    return this.file ? path.basename(this.file.path) : 'New Filter Editor';
  }

  getURI() {
    // Used by Atom to identify the view when toggling.
    return this.file ? this.file.path : 'atom://open-diabetes-vault-suite';
  }
}
