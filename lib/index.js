  ...
  activate(state) {
    ...
    this.subscriptions = new CompositeDisposable(
      ...
      atom.workspace.addOpener(uri => {
        ...
        } else if (uri === 'atom://open-diabetes-vault-suite') {
          // open new ODF editor
      ...
      atom.commands.add('atom-workspace', {
        'open-diabetes-vault-suite:check-settings': () => this.checkSettings(false),
        'open-diabetes-vault-suite:editor': () => atom.workspace.open('atom://open-diabetes-vault-suite'),
        'open-diabetes-vault-suite:initialize-repository': () => odv.initializeVault(),
        'open-diabetes-vault-suite:plot': () => atom.workspace.open('atom://open-diabetes-plot'),
        'open-diabetes-vault-suite:settings': () => atom.workspace.open('atom://config/packages/open-diabetes-vault-suite'),
        'open-diabetes-vault-suite:vault': () => atom.workspace.open('atom://open-diabetes-vault')
      }),
